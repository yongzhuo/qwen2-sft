...
if __name__ == '__main__':
    ...
    path = "E:/DATA/bert-model/00_pytorch/LLM/Qwen_Qwen1.5-0.5B-Chat"
    tokenizer = Qwen2Tokenizer.from_pretrained(path)
    # tokenizer.save_vocabulary()
    vocab_dict = tokenizer.get_vocab()
    save_json(vocab_dict, "qwen1.5_vocab_dict.json")
    ...
    tokens11 = tokenizer.apply_chat_template(
        messages,
        tokenize=False,
    ...
    tokens = tokenizer.tokenize(tokens11, do_lower_case=True)
    print(tokens)
    ...
    path = "E:/DATA/bert-model/00_pytorch/LLM/Qwen_Qwen1.5-14B-Chat"
    tokenizer2 = Qwen2Tokenizer.from_pretrained(path)
    tokens = tokenizer2("Hello world")["input_ids"]
    print(tokens)
    tokens = tokenizer.tokenize(tokens11, do_lower_case=True)
    print(tokens)
...
[151644, 82, 88, 82, 83, 68, 76, 198, 56, 78, 84, 220, 64, 81, 68, 220, 64, 220, 71, 68, 75, 79, 69, 84, 75, 220, 64, 82, 82, 72, 82, 83, 64, 77, 83, 13, 151645, 198, 151644, 84, 82, 68, 81, 198, 151645, 198, 151644, 64, 82, 82, 72, 82, 83, 64, 77, 83, 198]
"""
